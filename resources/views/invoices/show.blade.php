    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading panel-header">
                    <h3 class="text-center"><strong>Verification Report</strong></h3>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><strong>Verified On</strong></td>
                                <td class="text-center"><strong>Verified By</strong></td>
                                <td class="text-right"><strong>Status Code</strong></td>
                            </tr>
        ...
        <div class="col-md-4">
            <div class="sidebarbox">
                ...
                Report Sent: {{$invoice->sent_at ? __('yes') : __('no') }} <br/>
                Report Approved: {{$invoice->payment_received_at ? __('yes') : __('no') }} <br/>
