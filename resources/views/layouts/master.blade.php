...
<head>
    ...
    <link href="{{ URL::asset('css/dropzone.css') }}" rel="stylesheet" type="text/css">
        ...
        <link href="{{ URL::asset('plugins/alpaca.min.css') }}" rel="stylesheet" type="text/css">
...
$('body').click(function(e) {
  if ($('.menu').hasClass('bar')) {
        ...
        <div class="list-group panel">
            ...
            <div class="collapse" id="tasks">
                ...
                @if(Entrust::can('task-create'))
                    <a href="{{ route('tasks.create')}}" class="list-group-item childlist">New Case</a>
                @endif
                @if(Entrust::can('casebuilder'))
                    <a href="{{ route('casebuilder.buildform')}}" class="list-group-item childlist">Form Builder</a>
                @endif
            </div>
    ...
    <script type="text/javascript" src="{{ URL::asset('plugins/handlebars.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/jquery.caret.min.js') }}"></script>
        ...
        <script type="text/javascript" src="{{ URL::asset('plugins/alpaca.min.js') }}"></script>

        <script type="text/javascript" src="{{ URL::asset('plugins/jsonform/deps/opt/jsv.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('plugins/jsonform/lib/jsonform.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('components/jsontoform.js') }}"></script>
        <script type="text/javascript" src="{{ URL::asset('components/sweetalert/swal.min.js') }}"></script>

        <script type="text/javascript" src="{{ URL::asset('components/case.js') }}"></script>
@stack('scripts')
</body>
