...
class User extends Authenticatable
{
    ...
    public function getAllowAssignUsers(){
//         SELECT role_user.user_id                 AS user_id, 
//        department_user.department_id     AS department_id, 
//        role_user.role_id                 AS role_id, 
//        allowed_assign.allowed_department AS `allowed_department` 
// FROM   role_user 
//        JOIN department_user 
//          ON department_user.user_id = role_user.user_id 
//        JOIN allowed_assign 
//          ON department_user.department_id = allowed_assign.allowed_department 
