...
class ClientsController extends Controller
{
    ...
    public function anyData()
    {
        ...
        return Datatables::of($clients)
            ...
            ->add_column('edit', '
                <a href="{{ route(\'clients.edit\', $id) }}" class="btn btn-success" >Edit Profile</a>')
                ->addColumn('edit_cr', '
                <a href="{{ route(\'clients.edit_cr\', $id) }}" class="btn btn-success" >Edit Request Order</a>')
            ->add_column('delete', '
    ...
    public function update_cr($id, Request $request){

        $client = Client::find($id);
        $client->fieldAttribute()->sync([]);
        $client->fieldAttribute()->sync($request->fieldattr_id);
        
        Session()->flash('flash_message', 'Client Request successfully updated for: '.$client->name);
        return redirect()->route('clients.index');
